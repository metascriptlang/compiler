...
- **A session ends with its work committed and the arc's state written to its memory note** — the next session continues from the record, not from rediscovery.
